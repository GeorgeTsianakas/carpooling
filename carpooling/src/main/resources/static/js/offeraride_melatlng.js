...
function xristina(param,mark){
  ...
  autocomplete_to.addListener('place_changed', function(){ xristina(autocomplete_to,marker2); });
  autocomplete_from.addListener('place_changed',function(){ xristina(autocomplete_from,marker1); });
