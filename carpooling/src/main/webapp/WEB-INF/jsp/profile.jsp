...
<div class="ex2 w3-row-padding w3-container w3-padding">
    <table class="w3-table w3-twothird w3-padding float_center  ">
        <tr class="w3-padding">
            ...
            <td colspan="2">
                <h2><c:out value="${sessionScope.loggedinuser.firstname}"/> <c:out
                        value="${sessionScope.loggedinuser.lastname}"/></h2>
            ...
            <td>
                <div class="w3-display-container">
                    ...
                    <a href="${pageContext.request.contextPath}/updateuser"
                       class="w3-btn w3-right w3-tiny w3-round-large w3-blue">Update Profile</a>
                </div>
            </td>
            <td>
...
<div id="modalform" class="w3-modal">
    <div class="w3-modal-content w3-animate-zoom w3-round-large">
        <div class="w3-container">
            ...
            <form class="w3-padding w3-margin" action="${pageContext.request.contextPath}/uploadphoto" method="POST"
