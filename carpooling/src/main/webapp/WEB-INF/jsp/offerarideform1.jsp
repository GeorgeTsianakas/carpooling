...
<div class="container-fluid mainmenu-size">
    <div class="row">
        ...
        <div class="col-sm-8 col-md-7 col-lg-5 inputs-location">
            <springForm:form method="Post" modelAttribute="newtrip"
                             action="${pageContext.request.contextPath}/doinserttrip">

                <div id="pac-container" class="row">
                    <div class="col-12">
                        <h2 id="myTitle">Offer a Ride</h2>
                        <springForm:input path="origin" id="pac-input-from" type="text" class=" button4 button3"
                ...
                <div id="pac-container" class="row">
                    <div class="col-12">
                        <springForm:input path="destination" id="pac-input-to" type="text" class=" button4 button3"
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <springForm:input path="totalseats" type="hidden" class=" button5 button3" name="quantity"
                                          value="4"/>
                    </div>
                </div>
                <div class=" row">
                    ...
                    <div class="col-4">
                        <springForm:input path="availableseats" type="number" class=" button5 button3" name="quantity"
                                          min="1" max="4"/>
                ...
                <div class="row">
                    <div class="col-12">
                        <springForm:textarea path="info" rows="3" cols="50" class=" button6 button3"
                                             placeholder="Add some information about your trip"/>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
